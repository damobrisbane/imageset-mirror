...
./mirror1-v1.sh examples/manifests registry.local.lan
...
oc-mirror --from ./ --skip-image-pin --skip-cleanup --skip-metadata-check --skip-missing --skip-pruning docker://registry.local.lan/20241108
..
Checking push permissions for registry.local.lan
using --skip-pruning flag - pruning will be skipped
Publishing image set from archive "./" to registry "registry.local.lan"
registry.local.lan/
...
sha256:50337e2a6648f985610d6e2ba605bdd38233eb8ea04a5d22118cb29636da730c registry.local.lan/20241108/gitlab-org/gl-openshift/gitlab-runner-operator/gitlab-runner-operator:4d9dd392
...
Rendering catalog image "registry.local.lan/20241108/redhat/certified-operator-index:20241108" with file-based catalog 
Rendering catalog image "registry.local.lan/20241108/redhat/community-operator-index:20241108" with file-based catalog 
...
```
curl -s https://registry.local.lan/v2/_catalog |jq |grep 2024
